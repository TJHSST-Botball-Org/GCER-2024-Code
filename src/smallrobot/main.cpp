...
int main()
{
	...
	for (int i = 0; i < 4; ++i) 
	{
        	robot.rotateAndCorrect(45.0, 300);
	...
	robot.rotateAndCorrect(8.0, 400);
	//move to the airlock
	...
	robot.rotateAndCorrect(180, 300);
